...
- **Dashboard**: today's sheet of every stock (latest close, predicted price in 1 month, expected change, chance of ending higher), sortable and filterable.
...
- NIFTY 50 constituents change twice a year. Update `symbols.json` when they do.
